...
export const countryList = ['ae','ar','at','au','be','bg','br','ca','ch','cn','co','cu','cz','de','eg','fr','gb','gr','hk','hu','id','ie',
...
export function getCountryFullName (countryCode) {
    let country = countryListAllIsoData.find(item => item.code === countryCode.toUpperCase());
...
export default function getCountryName (countryCode) {
    let country = countryListAllIsoData.find(item => item.code === countryCode.toUpperCase());
    return country?.code3 || countryCode.toUpperCase()
